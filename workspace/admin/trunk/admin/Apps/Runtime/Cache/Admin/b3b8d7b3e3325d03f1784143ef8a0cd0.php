...
<link href="/Public/css/review/review.css" rel="stylesheet" type="text/css">
<script src="/Public/js/review_manager/jquery-1.8.3.min.js"></script>
</head>
<body>
...
<div id="addbox">
    ...
    <form class="addform" action="/index.php/Review/addReview/" method="post" enctype="multipart/form-data"> 
...
<form action="/index.php/Review/getList/" method="post">
	...
	<tbody id="admin_role_list" align="center">
	   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="<<?php echo ($vo["review_id"]); ?>>">
			...
			<td><<?php echo ($vo["creation_time"]); ?>></td>
                        <td>
                             <?php if(($vo["url"] != '') ): ?><img src="<<?php echo (UPLOADS_FILE); ?>><<?php echo ($vo["url"]); ?>>" width="100"><?php endif; ?>
                        </td>
